...
public class Constants {
    public static final String INVALID_USER_NAME = "User is not present for given username";
    ...
    public static final String BAD_CREDENTINALS= "Invalid userName and password";
